...
class MTurkServicesWrapper(object):
    ...
    def _generate_hit_config(self, ad_location, num_workers, reward, duration):
        hit_config = {
            ...
            "manual_qualification_id": self.config.get('HIT Configuration',
                                                       'manual_qualification_id',
                                                       raw=True),
            "manual_qualification_min_percent": self.config.getint('HIT Configuration',
                                                                'manual_qualification_min_percent'),
